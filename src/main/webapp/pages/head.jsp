...
<div id="dengluinput"
    ...
    <div style="padding: 30px 30px;">
        <form id="form1" action="login" method="post">
            ...
            <input class="denglu-input" id="username" type="text" name="username"><br>
            <label for="password">密码</label>
            <input class="denglu-input" id="password" type="password" name="password"><br>
            <label id="labelrpw" for="rpassword"><br></label> <br/>
            <label for="varcode">验证码</label> <br>
        ...
        <button id="tijiao" onclick="quickpasswordchat()" type="button"
                style="color: #fff; margin-top: 20px; border-color: #c20a0a; width: 90%; height: 50px; background: #c20a0a;">
            登录
        </button>
        ...
        <div class="collapse navbar-collapse"
            ...
            <form class="navbar-form navbar-left" action="coursesearch"
                ...
                <input type="text" name="search" class="form-control"
                       placeholder="课程名">
                <button type="submit" class="btn"><span class="glyphicon glyphicon-search"></span>查找</button>
            </form>
            <ul class="nav navbar-nav navbar-right">
                <c:if test="${loginUser != null }">
                    ...
                    <li class="dropdown"><a href="#" class="dropdown-toggle"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="logout" class="glyphicon glyphicon-inbox">退出帐号</a></li>
                ...
                <c:if test="${loginUser == null }">
                    ...
                    <li>
                        <a href="#" onclick="showdenglu()"><span class="glyphicon glyphicon-user"></span>注册</a>
                    </li>
                    <%--<li><a href="#">关于 </a></li>--%>
                </c:if>
