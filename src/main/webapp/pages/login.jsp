...
<div id="ui" style="text-align:center;">
    <div class="user ">
        <div class="logo" style="margin-bottom: 20px;margin-top: 20px; margin-right: 20px; ">
            <a href=#>
                <img src="${pageContext.request.contextPath }/style/image/11.png" width="204px" class="img-rounded"></a>
        </div>
        <!-- uiView:  -->
                ...
                <form id="login1" action="login" method="post"
                    ...
                    <label class="col-md-3 control-label"
                           for="varcode">验证码</label> <br><input class="form-control input-lg" id="varcode"
                                                                type="text" name="varcode"><img
                        onclick="changevarcode()" id="varcodeimg" alt="验证码" src="changevarcode"
